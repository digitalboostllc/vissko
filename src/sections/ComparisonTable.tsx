    ...
    <section className="py-24 bg-white relative">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="border border-zinc-200 rounded-3xl bg-white mt-6">
            
            {/* Header Row */}
            <div className="grid grid-cols-[1.2fr_1fr_1fr] md:grid-cols-3 bg-zinc-50 border-b border-zinc-200 rounded-t-3xl">
              <div className="p-6 md:p-8 rounded-tl-3xl"></div>
              ...
              <div className="p-2 md:p-8 text-center flex flex-col justify-center rounded-tr-3xl">
