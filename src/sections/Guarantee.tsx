    ...
    <section className="py-24 bg-white text-zinc-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12 bg-zinc-50 border border-zinc-200 rounded-[2.5rem] p-8 md:p-16">
            ...
            >
              <div className="w-32 h-32 md:w-40 md:h-40 bg-white border border-zinc-200 rounded-full flex items-center justify-center relative">
                ...
                <ShieldCheck className="w-16 h-16 md:w-20 md:h-20 text-emerald-500" />
              </div>
            </motion.div>
            ...
            <div className="flex flex-col text-center md:text-left">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">
                ...
                <span className="text-emerald-500">Satisfait ou Remboursé</span>
              </h2>
              <p className="text-zinc-500 text-lg mb-8 leading-relaxed">
                ...
                <strong className="text-zinc-900 font-bold"> Zéro question. Zéro tracas.</strong>
              </p>
