    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-auto max-w-md bg-white/95 backdrop-blur-xl border border-black/10 rounded-full shadow-2xl z-50 p-2 pl-6 flex items-center justify-between gap-6"
        >
